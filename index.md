...
<div class="card-grid">
  ...
  <a class="card" href="https://wassupluke.com/claude-courses/" target="_blank" rel="noopener noreferrer">
    <h3>Claude Courses</h3>
    <p>Hands-on lessons for learning to use Claude effectively — prompting, workflows, and practical technique.</p>
    <span class="card-link">wassupluke.com/claude-courses</span>
  </a>
  <a class="card" href="https://wassupluke.com/ai-digest/" target="_blank" rel="noopener noreferrer">
    <h3>AI Digest</h3>
    <p>A weekly synthesis of recent cs.AI / cs.SE arXiv papers, filtered for actionable prompting and Claude techniques.</p>
    <span class="card-link">wassupluke.com/ai-digest</span>
  </a>
  <a class="card" href="https://wassupluke.com/bible/" target="_blank" rel="noopener noreferrer">
    <h3>ASV Bible Visualizer</h3>
    <p>An interactive visualization of the ASV Bible — one of my Bible-based code projects.</p>
    <span class="card-link">wassupluke.com/bible</span>
  </a>
</div>
